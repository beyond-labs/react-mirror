(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["react-mirror"] = factory();
	else
		root["react-mirror"] = factory();
})(this, function() {
...
var _subNamesToKeys = __webpack_require__(11);
...
var normalizeState = exports.normalizeState = function normalizeState(subscriptions, path, rootState) {
  ...
  var _map = [ownKey].concat(_toConsumableArray(subscriptionKeys)).map(function (key) {
  ...
  context = _lodash2.default.zip(subscriptions, context);
...
var _createRootStore = __webpack_require__(25);

var _createRootStore2 = _interopRequireDefault(_createRootStore);

var _createLocalStore = __webpack_require__(24);
  ...
  return function wrapWithMirror(WrappedComponent) {
    ...
    var Mirror = function (_Component) {
      ...
      function Mirror(props, context) {
        ...
        var _this = _possibleConstructorReturn(this, (Mirror.__proto__ || Object.getPrototypeOf(Mirror)).call(this));
        // TODO: throw if:
        ...
        _this.localStore.dispatch('INITIALIZE', _lodash2.default.omit(props, 'subscribe'));
      ...
      _createClass(Mirror, [{
        ...
        value: function shouldComponentUpdate(nextProps, nextState) {
          ...
          this.localStore.dispatch('UPDATE_PROPS', _lodash2.default.omit(nextProps, 'subscribe'));
        }
      }, {
        ...
        value: function render() {
          ...
          var props = _extends({}, state, { context: context, dispatch: this.localStore.dispatch, subscribe: this.localStore.subscribe });
...
var _normalizeState3 = __webpack_require__(10);
...
var _dispatch = function _dispatch() {
  ...
  action = _lodash2.default.set(action, 'meta.store', store);
  action = _lodash2.default.set(action, 'meta.origin', key);
...
var dispatch = function dispatch(instance) {
  return function () {
    ...
    return _dispatch(_extends({ type: type, payload: payload }, metadata), context, instance);
  };
};
...
var createLocalStore = exports.createLocalStore = function createLocalStore(instance, config, options) {
  ...
  var cancelRootSubscription = rootStore.subscribe(function (storeUpdated, action, rootState, rootPrevState) {
    ...
    if (shouldUpdate(pure, storeUpdated, [].concat(_toConsumableArray(contextSubscribeKeys), [key]), _extends({}, state, { context: context }), _extends({}, prevState, { context: prevContext }))) {
...
var _normalizeState2 = __webpack_require__(10);
...
var addStore = function addStore(state, store) {
  ...
  state = _lodash2.default.set(state, ['stores', key], { meta: store, state: {} });
  return state;
};

var removeStore = function removeStore(state, key) {
  state = _lodash2.default.omit(state, 'stores.' + key);
  return state;
};
...
var updateState = function updateState(state, action) {
  ...
  if (!_lodash2.default.get(action, 'meta.store')) return state;
  ...
  state = _lodash2.default.set(state, ['stores', key, 'state'], nextState);

  var isRoot = store.meta.path.length === 1;
  if (isRoot) {
    state = _extends({}, state.stores[key].state, { stores: state.stores });
  }
  ...
  return function (next) {
    return function (action) {
      if (!_lodash2.default.get(action, 'meta.store')) {
        ...
        var key = _lodash2.default.get(rootStore, 'meta.path', []).slice(-1)[0] || null;
        action = _lodash2.default.set(action, 'meta.store', key);
      }
      return next(action);
    };
  };
